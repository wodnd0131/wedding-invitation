  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 right-[max(1rem,calc((100vw-480px)/2+1rem))] z-[90] flex h-10 w-10 cursor-pointer items-center justify-center rounded-full border border-gold-soft bg-ivory text-wine"
      >
        {playing ? (
